...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM_Generator_v1_0_S00_AXI is
  ...
  signal \clk_div_reg__0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal clk_scaled : STD_LOGIC;
  signal clk_scaled_i_1_n_0 : STD_LOGIC;
...
\clk_div[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
clk_scaled_i_1: unisim.vcomponents.LUT6
    generic map(
...
clk_scaled_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\counter[31]_LDC_i_16\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \counter[12]_P_n_0\,
      I3 => \counter[13]_C_n_0\,
      I4 => \counter[13]_LDC_n_0\,
      I5 => \counter[13]_P_n_0\,
