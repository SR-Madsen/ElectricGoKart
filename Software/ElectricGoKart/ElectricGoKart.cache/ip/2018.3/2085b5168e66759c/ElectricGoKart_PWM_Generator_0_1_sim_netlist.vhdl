...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM_Generator_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of XADC_conv_en_INST_0_i_1 : label is "soft_lutpair1";
...
XADC_conv_en_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => counter(2),
      I3 => counter(3),
      I4 => XADC_conv_en_INST_0_i_3_n_0,
      I5 => XADC_conv_en_INST_0_i_4_n_0,
      O => XADC_conv_en
    );
XADC_conv_en_INST_0_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
XADC_conv_en_INST_0_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
XADC_conv_en_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => XADC_conv_en_INST_0_i_6_n_0,
      I2 => XADC_conv_en_INST_0_i_7_n_0,
      I3 => XADC_conv_en_INST_0_i_8_n_0,
      I4 => XADC_conv_en_INST_0_i_9_n_0,
      I5 => XADC_conv_en_INST_0_i_10_n_0,
...
XADC_conv_en_INST_0_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
XADC_conv_en_INST_0_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
XADC_conv_en_INST_0_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
XADC_conv_en_INST_0_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
XADC_conv_en_INST_0_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
state_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => XADC_conv_en_INST_0_i_2_n_0,
      I2 => state_i_2_n_0,
      I3 => XADC_conv_en_INST_0_i_1_n_0,
      I4 => state_i_3_n_0,
      I5 => state_reg_n_0,
      O => state_i_1_n_0
    );
