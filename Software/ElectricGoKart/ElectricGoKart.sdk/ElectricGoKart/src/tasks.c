...
void communicationTask() {
	...
	case UART_SET_D:
		if ((!read_bytes) && (!set_variable)) {
			...
			xil_printf("Write a number for the variable you wish to change, followed by the value (00.00 to 99.99) it must have.\r\n");
			xil_printf("1: a0\r\n");
			xil_printf("2: a1\r\n");
			xil_printf("3: b1\r\n");
			xil_printf("4: Limit\r\n");
			...
			if (!(uart_cmd == 27)) {
				...
				if (read_bytes >= 5) {
					switch (set_variable) {
					case 1:
						dController.a_0 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 2:
						dController.a_1 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 3:
						dController.b_1 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 4:
						dController.limit = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
					}
					set_variable = 0;
					read_bytes = 0;
					uart_state = UART_PI;
		...
		if ((!read_bytes) && (!set_variable)) {
			...
			if (!(uart_cmd == 27)) {
				...
				if (read_bytes >= 5) {
					switch (set_variable) {
					case 1:
						qController.a_0 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 2:
						qController.a_1 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 3:
						qController.b_1 = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
						break;
					case 4:
						qController.limit = set_value[0]*10.0 + set_value[1] + set_value[2]/10.0 + set_value[3]/100.0 + set_value[4]/1000.0;
					}
					set_variable = 0;
					read_bytes = 0;
					uart_state = UART_PI;
