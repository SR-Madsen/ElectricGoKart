...
#define NEG_OVERCURRENT_THRESHOLD 4095-OVERCURRENT_THRESHOLD

#define BATTERY_CONVERSION (f32)0.015140415140415140415140415140415
#define TORQUE_CONVERSION (f32)0.03069868403201736484220418788027
#define OVERCURR_CONVERSION (f32)0.084420024420024420024420024420024
#define CURRENT_CONVERSION (f32)0.15873015873015873015873015873016
