...
void disableEncoder() {
	ENCODER_DRIVER_mWriteReg(ENCODER_DRIVER_BASEADDR, ENCODER_DRIVER_S00_AXI_SLV_REG1_OFFSET, DISABLE);
}

void enableEncoder() {
	ENCODER_DRIVER_mWriteReg(ENCODER_DRIVER_BASEADDR, ENCODER_DRIVER_S00_AXI_SLV_REG1_OFFSET, ENABLE);
}

void disablePWM() {
	PWM_GENERATOR_mWriteReg(PWM_GENERATOR_BASEADDR, PWM_GENERATOR_S00_AXI_SLV_REG3_OFFSET, DISABLE);
}

void enablePWM() {
	PWM_GENERATOR_mWriteReg(PWM_GENERATOR_BASEADDR, PWM_GENERATOR_S00_AXI_SLV_REG3_OFFSET, ENABLE);
}
