...
architecture STRUCTURE of ElectricGoKart_Encoder_Driver_0_0_Encoder_Driver_v1_0_S00_AXI is
  ...
  signal SERIAL_CLOCK0 : STD_LOGIC;
  signal SERIAL_CLOCK_i_10_n_0 : STD_LOGIC;
  signal SERIAL_CLOCK_i_11_n_0 : STD_LOGIC;
  ...
  signal SERIAL_CLOCK_i_6_n_0 : STD_LOGIC;
  signal SERIAL_CLOCK_i_7_n_0 : STD_LOGIC;
  signal SERIAL_CLOCK_i_8_n_0 : STD_LOGIC;
  signal SERIAL_CLOCK_i_9_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_10 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_11 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_4 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_5 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_6 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_7 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_8 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_9 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \data_temp[0]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_temp[1]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_temp[2]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_temp[3]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_temp[4]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_temp[5]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_temp[6]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_temp[6]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_temp[7]_i_10\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_temp[7]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_temp[7]_i_5\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \index[0]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \position[7]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \position[7]_i_3\ : label is "soft_lutpair1";
...
SERIAL_CLOCK_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index_reg(23),
      I3 => index_reg(22),
      O => SERIAL_CLOCK_i_10_n_0
    );
SERIAL_CLOCK_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index_reg(31),
      I3 => index_reg(30),
      O => SERIAL_CLOCK_i_11_n_0
    );
SERIAL_CLOCK_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => SERIAL_CLOCK_i_5_n_0,
      I1 => SERIAL_CLOCK_i_6_n_0,
      I2 => SERIAL_CLOCK_i_7_n_0,
      I3 => SERIAL_CLOCK_i_8_n_0,
      O => SERIAL_CLOCK_i_2_n_0
    );
SERIAL_CLOCK_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFEFFFFFFF"
    )
        port map (
      I0 => SERIAL_CLOCK_i_9_n_0,
      I1 => SERIAL_CLOCK_i_10_n_0,
      I2 => index_reg(2),
      I3 => index_reg(1),
      I4 => index_reg(0),
      I5 => SERIAL_CLOCK_i_11_n_0,
...
SERIAL_CLOCK_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index_reg(7),
      I3 => index_reg(6),
      O => SERIAL_CLOCK_i_6_n_0
    );
SERIAL_CLOCK_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index_reg(19),
      I3 => index_reg(18),
      O => SERIAL_CLOCK_i_7_n_0
    );
SERIAL_CLOCK_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index_reg(15),
      I3 => index_reg(14),
      O => SERIAL_CLOCK_i_8_n_0
    );
SERIAL_CLOCK_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\index[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \state[0]_i_3_n_0\,
      I1 => \state[0]_i_2_n_0\,
      I2 => \position[7]_i_3_n_0\,
      I3 => \position[7]_i_2_n_0\,
      I4 => index_reg(3),
      I5 => \index[0]_i_3_n_0\,
      O => index0
    );
...
\position[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
...
\state[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => INC_A,
      I2 => index_reg(3),
      I3 => SERIAL_CLOCK_i_3_n_0,
      I4 => SERIAL_CLOCK_i_2_n_0,
      I5 => \state_reg_n_0_[1]\,
      O => \state[1]_i_1_n_0\
    );
