...
architecture STRUCTURE of ElectricGoKart_PWM_Generator_0_1_PWM_Generator_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of XADC_conv_en_i_3 : label is "soft_lutpair1";
...
XADC_conv_en_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
XADC_conv_en_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
XADC_conv_en_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
XADC_conv_en_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
XADC_conv_en_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
XADC_conv_en_i_9: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
