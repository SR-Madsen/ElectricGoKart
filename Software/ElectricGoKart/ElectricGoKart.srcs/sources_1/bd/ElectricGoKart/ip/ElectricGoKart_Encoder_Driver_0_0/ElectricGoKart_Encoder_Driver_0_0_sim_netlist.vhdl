...
architecture STRUCTURE of ElectricGoKart_Encoder_Driver_0_0_Encoder_Driver_v1_0_S00_AXI is
  ...
  signal \position[1]_i_2_n_0\ : STD_LOGIC;
  signal \position[2]_i_1_n_0\ : STD_LOGIC;
  signal \position[2]_i_2_n_0\ : STD_LOGIC;
  signal \position[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_4 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \data_temp[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_temp[1]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_temp[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_temp[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_temp[5]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_temp[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_temp[7]_i_10\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_temp[7]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_temp[7]_i_8\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_temp[7]_i_9\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \position[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \position[2]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \position[2]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \position[4]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \position[4]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \position[4]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \position[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \position[7]_i_12\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \position[7]_i_13\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \position[7]_i_14\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \position[7]_i_15\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \position[7]_i_4\ : label is "soft_lutpair6";
...
\data_temp[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFF0200"
    )
        port map (
...
\data_temp[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\data_temp[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\data_temp[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
...
\data_temp[6]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\data_temp[6]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\data_temp[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
\data_temp[7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\data_temp[7]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\data_temp[7]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\position[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\position[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
\position[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\position[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AA64"
    )
        port map (
...
\position[4]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\position[4]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\position[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\position[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\position[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\position[7]_i_15\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\position[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\position[7]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0FFAEC6"
    )
        port map (
...
\position[7]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
