...
architecture STRUCTURE of ElectricGoKart_Encoder_Driver_0_0_Encoder_Driver_v1_0_S00_AXI is
  ...
  signal clk_div0_carry_i_7_n_0 : STD_LOGIC;
...
clk_div0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => '0',
      DI(1) => clk_div0_carry_i_2_n_0,
      DI(0) => clk_div0_carry_i_3_n_0,
      O(3 downto 0) => NLW_clk_div0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => clk_div0_carry_i_4_n_0,
      S(2) => clk_div0_carry_i_5_n_0,
      S(1) => clk_div0_carry_i_6_n_0,
      S(0) => clk_div0_carry_i_7_n_0
    );
...
clk_div0_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
