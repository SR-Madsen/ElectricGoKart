...
-- Date        : Fri Mar 26 11:34:36 2021
-- Host        : sebastian-ZBook running 64-bit Linux Mint 20
-- Command     : write_vhdl -force -mode funcsim -rename_top ElectricGoKart_Encoder_Driver_0_0 -prefix
--               ElectricGoKart_Encoder_Driver_0_0_ ElectricGoKart_Encoder_Driver_0_1_sim_netlist.vhdl
-- Design      : ElectricGoKart_Encoder_Driver_0_1
...
architecture STRUCTURE of ElectricGoKart_Encoder_Driver_0_0_Encoder_Driver_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_10 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_11 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_5 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_6 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_7 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of SERIAL_CLOCK_i_8 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \data_temp[3]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_temp[4]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_temp[5]_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \data_temp[7]_i_10\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \position[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \position[7]_i_3\ : label is "soft_lutpair0";
...
temp_clock_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
temp_clock_reg: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
entity ElectricGoKart_Encoder_Driver_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of ElectricGoKart_Encoder_Driver_0_0 : entity is "ElectricGoKart_Encoder_Driver_0_1,Encoder_Driver_v1_0,{}";
...
architecture STRUCTURE of ElectricGoKart_Encoder_Driver_0_0 is
  ...
  attribute x_interface_parameter of SERIAL_CLOCK : signal is "XIL_INTERFACENAME SERIAL_CLOCK, FREQ_HZ 900000, PHASE 0.000, CLK_DOMAIN ElectricGoKart_Encoder_Driver_0_1_SERIAL_CLOCK, INSERT_VIP 0";
