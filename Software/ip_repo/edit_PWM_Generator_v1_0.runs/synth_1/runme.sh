...
HD_PWD='/home/sebastian/Desktop/Git/SDU/ElectricGoKart/Software/ip_repo/edit_PWM_Generator_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Generator_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_Generator_v1_0.tcl
