...
HD_PWD='/home/sebastian/Desktop/Git/SDU/ElectricGoKart/Software/ip_repo/edit_PWM_Generator_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Generator_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_Generator_v1_0.tcl -notrace
